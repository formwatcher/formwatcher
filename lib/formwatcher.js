...
(function() {
  var Formwatcher, bean, bonzo, domready, qwery,
    __slice = [].slice,
  ...
  Formwatcher = {
    ...
    registerDecorator: function(decorator) {
      ...
      return this.debug("Registered decorator '" + decorator.prototype.name + "'.");
    },
    ...
    registerValidator: function(validator) {
      ...
      return this.debug("Register validator '" + validator.prototype.name + "'.");
    },
    currentWatcherId: 0,
    watchers: [],
