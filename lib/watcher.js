...
(function() {
  ...
  Watcher = (function() {
    ...
    function Watcher(form, options) {
      var Decorator, Validator, element, elements, errorsElement, hiddenSubmitButtonElement, i, input, label, onchangeFunction, submitButtons, validateElementsFunction, validator, _fn, _fn1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      _fn1 = function(element) {
        return bean.on(element, "click", function(e) {
          ...
          if (element[0].tagName === "BUTTON") {
            ...
            element.text("");
            elementValue = (_ref5 = element.val()) != null ? _ref5 : "";
            element.text(tmpElementText);
          } else {
            elementValue = (_ref6 = element.val()) != null ? _ref6 : "";
          }
          bonzo(hiddenSubmitButtonElement).attr("name", element.attr("name") || "").val(elementValue);
          _this.submitForm();
