...
(function() {
  ...
  Watcher = (function() {
    ...
    function Watcher(form, options) {
      var Decorator, Validator, element, hiddenSubmitButtonElement, input, submitButtons, _fn, _fn1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3,
        _this = this;
      ...
      _fn = function(input) {
        var binput, element, elements, errorsElement, i, label, onchangeFunction, validateElementsFunction, validator, _l, _len3, _ref4, _results;
        binput = bonzo(input);
        if (!binput.fwData("initialized")) {
          binput.fwData("initialized", true);
          if (binput.attr("type") === "hidden") {
            return binput.fwData("forceSubmission", true);
          } else {
      ...
      _fn1 = function(element) {
        ...
        return bean.on(element, "click", function(e) {
          var elementValue, tmpElementText, _ref4, _ref5;
          if (element.tagName === "BUTTON") {
            tmpElementText = belement.text();
            belement.text("");
            elementValue = (_ref4 = belement.val()) != null ? _ref4 : "";
    ...
    Watcher.prototype.validateElements = function(elements, inlineValidating) {
      var binput, element, i, sanitizedValue, validated, validationOutput, validator, _i, _j, _len, _len1, _ref, _ref1;
      binput = bonzo(elements.input);
      validated = true;
      if (binput.fwData("validators").length) {
        if (!inlineValidating || !binput.fwData("lastValidatedValue") || binput.fwData("lastValidatedValue") !== binput.val()) {
          ...
          _ref = binput.fwData("validators");
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            validator = _ref[_i];
            if (binput.val() === "" && validator.name !== "Required") {
          ...
          if (validated) {
            ...
            if (inlineValidating) {
              binput.fwData("forceValidationOnChange", true);
            }
          } else {
            for (i in elements) {
              if (!__hasProp.call(elements, i)) continue;
        ...
        if (!inlineValidating && validated) {
          ...
          _ref1 = binput.fwData("validators");
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            validator = _ref1[_j];
