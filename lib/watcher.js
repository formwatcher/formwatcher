  ...
  Watcher = (function() {
    ...
    function Watcher(form, options) {
      ...
      if (this.options.ajaxMethod === null) {
        this.options.ajaxMethod = (_ref4 = this.bonzoForm.attr("method")) != null ? _ref4.toLowerCase() : void 0;
      }
      ...
      _fn = function(input) {
        var binput, element, elements, errorsElement, i, label, onchangeFunction, validateElementsFunction, validator, _l, _len3, _ref6, _results;
        binput = bonzo(input);
        if (!binput.fwData("initialized")) {
          ...
          if (binput.attr("type") === "hidden") {
            ...
            for (_l = 0, _len3 = _ref6.length; _l < _len3; _l++) {
              validator = _ref6[_l];
              if ((_this.watcher.options[_this.name] != null) && _this.watcher.options[_this.name] === false) {
                return false;
              }
    ...
    Watcher.prototype.validateElements = function(elements, inlineValidating) {
      var binput, element, formattedValue, i, validated, validationOutput, validator, _i, _j, _len, _len1, _ref, _ref1;
      binput = bonzo(elements.input);
      validated = true;
